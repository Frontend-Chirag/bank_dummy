...
// importing quotes img from assets
import { quotes } from '../assets';


// passing props with properties of feedback array object 
const FeedbackCard = ({content, title, img, name}) => (
  <div className='flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[350px] md:mr-10 sm:mr-5 mr-0 
  feedback-card'>
